...
useSeoMetaDynamic({
  title: 'Dashboard Mitra - indonesiamarathon.com',
  description: 'Pantau status pengajuan event Anda dan kelola event lari Anda.',
  url: '/mitra/dashboard',
})
...
const breadcrumbItems = computed<BreadcrumbItem[]>(() => [{ text: 'Dashboard Mitra', link: null }])
