...
// Fetch events dengan month filter dan pagination
...
const seoDescription = computed(() => 
  `Temukan ${totalCount.value}+ jadwal event lari untuk bulan ${bulanName} ${year}. Rencanakan partisipasi marathon, fun run, dan trail running favoritmu!`
)
...
<template>
  <div>
    ...
    <LayoutPageHeader
      ...
      :description="`${totalCount} event lari di bulan ${bulanName} ${year}.`"
      ...
      <div class="layout-container">
        ...
        <div class="mb-8 rounded-2xl border border-secondary/30 bg-white p-6">
          ...
          <div class="prose prose-sm max-w-none text-gray-600">
            ...
            <p class="mb-0">
              <strong>{{ totalCount }} event</strong> tersedia untuk bulan ini. 
