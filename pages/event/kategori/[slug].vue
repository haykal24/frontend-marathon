...
const seoDescription = computed(() => 
  `Temukan ${totalEvents.value}+ jadwal ${categoryDesc.value} terbaru di Indonesia untuk ${currentYear}. Filter berdasarkan kota, tanggal, dan biaya pendaftaran. Update setiap hari!`
)
...
<template>
  <div>
    ...
    <LayoutPageHeader
      ...
      :description="`${totalEvents} event ${categoryDesc} terbaru di seluruh Indonesia untuk ${currentYear}.`"
      ...
      <div class="layout-container">
        ...
        <div class="mb-8 rounded-2xl border border-secondary/30 bg-white p-6">
          ...
          <div class="prose prose-sm max-w-none text-gray-600">
            ...
            <p class="mb-0">
              <strong>{{ totalEvents }} event</strong> tersedia untuk kategori ini. 
